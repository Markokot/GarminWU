...
ТЕКУЩАЯ ДАТА: {TODAY_DATE} ({TODAY_DOW}). Используй эту дату как "сегодня" во всех расчётах дат, при упоминании "завтра", "послезавтра", дней недели, и при планировании тренировок. НЕ ПРИДУМЫВАЙ другие даты — вычисляй от {TODAY_DATE}.
